...
}var ShowcasesPage = (_dec = (0, _nextReduxWrapper2.default)(_store2.default, function (_ref) {
  var app = _ref.app;return { counter: app.counter };
}), _dec(_class = function (_Component) {
  _inherits(ShowcasesPage, _Component);function ShowcasesPage() {
    _classCallCheck(this, ShowcasesPage);return _possibleConstructorReturn(this, (ShowcasesPage.__proto__ || Object.getPrototypeOf(ShowcasesPage)).apply(this, arguments));
  }_createClass(ShowcasesPage, [{ key: 'render', value: function render() {
      return _react2.default.createElement(_layout2.default, { url: this.props.url }, _react2.default.createElement(_reactNative.Text, null, 'ShowcasesPage'));
    } }]);return ShowcasesPage;
}(_react.Component)) || _class);exports.default = ShowcasesPage;
