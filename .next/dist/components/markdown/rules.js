  ...
  return {
    autolink: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.link,
          onPress: _lodash2.default.noop }, output(node.content, state));
      } },
    ...
    blockQuote: {
      react: function react(node, output, state) {
        ...
        var blockText = (0, _react.createElement)(_reactNative.Text, {
          key: state.key + 1,
          style: styles.blockQuoteText }, output(node.content, state));
    ...
    del: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.del }, output(node.content, state));
      } },
    ...
    em: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.em }, output(node.content, state));
      } },
    ...
    heading: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: [styles.heading, styles['heading' + node.level]] }, output(node.content, state));
      } },
    ...
    inlineCode: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.inlineCode }, output(node.content, state));
      } },
      ...
      react: function react(node, output, state) {
        var items = _lodash2.default.map(node.items, function (item, i) {
          ...
          return (0, _react.createElement)(_reactNative.View, {
            key: i,
            style: styles.listItem }, [bullet, listItemText]);
        });
    ...
    paragraph: {
      react: function react(node, output, state) {
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.paragraph }, output(node.content, state));
      } },
    ...
    strong: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.strong }, output(node.content, state));
      } },
    ...
    table: {
      react: function react(node, output, state) {
        var headers = _lodash2.default.map(node.header, function (content, i) {
          return (0, _react.createElement)(_reactNative.Text, {
            style: styles.tableHeaderCell }, output(content, state));
        });
        ...
        var rows = _lodash2.default.map(node.cells, function (row, r) {
          var cells = _lodash2.default.map(row, function (content, c) {
            return (0, _react.createElement)(_reactNative.View, {
              key: c,
              style: styles.tableRowCell }, output(content, state));
          });
    ...
    u: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.View, {
          key: state.key,
          style: styles.u }, output(node.content, state));
      } },
    ...
    url: {
      react: function react(node, output, state) {
        ...
        return (0, _react.createElement)(_reactNative.Text, {
          key: state.key,
          style: styles.url,
          onPress: openURL(node.target) }, output(node.content, state));
      } } };
};